...
function Footer() {
    ...
    const navigation = {
        ...
        social: [
            {
                name: 'Twitter',
                href: 'https://twitter.com/rossicodes',
                icon: (props) => (
                    <svg fill={iconColor} viewBox="0 0 24 24" {...props}>
            ...
            {
                name: 'GitHub',
                href: 'https://github.com/rossicodes',
                icon: (props) => (
                    <svg fill={iconColor} viewBox="0 0 24 24" {...props}>
                        <path
                            fillRule="evenodd"
            ...
            {
                name: 'Dribbble',
                href: 'https://dribbble.com/rwoodhurst',
                icon: (props) => (
                    <svg fill={iconColor} viewBox="0 0 24 24" {...props}>
                        <path
                            fillRule="evenodd"
    ...
    return (
        <footer className="bg-transparent">
            <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                ...
                <p className='hover:text-pink mt-8 text-center cursor-pointer'><a>by rossicodes</a></p>
                 </Link>
            </div>
        </footer>
    )
